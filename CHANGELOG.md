...
### [0.1.1](https://github.com/ThomasFourties/sc-planner/compare/v0.1.0...v0.1.1) (2025-06-15)
...
* clean up formatting and improve readability in auth and email services ([ad25106](https://github.com/ThomasFourties/sc-planner/commit/ad25106820578256b4a915540308209aa4be9d30))
...
* remove fake status function from reset-password page ([93cf25e](https://github.com/ThomasFourties/sc-planner/commit/93cf25e3a6855bc17e2b42502560a760193e06b4))
...
* rename user fields to snake_case across the application ([f10a863](https://github.com/ThomasFourties/sc-planner/commit/f10a863dfe59b21e8cd22185259453d5b770bfed))
...
* some fixes & remove comments ([90fa703](https://github.com/ThomasFourties/sc-planner/commit/90fa703f3e24a84c113e236fd9e5fb0649d31efa))
* some fixes & remove comments ([04ed4bb](https://github.com/ThomasFourties/sc-planner/commit/04ed4bb7f15958208728af5a8304a228a9f4d578))
...
* standardize user name fields to use snake_case ([d7771f8](https://github.com/ThomasFourties/sc-planner/commit/d7771f81b4b1de9d597709cc88a662985d0f77fb))
...
* add API_URL environment variable to production Docker configuration ([58f2375](https://github.com/ThomasFourties/sc-planner/commit/58f2375f5c736d65e6874d29d5af1420dfafc11f))
...
* add forgot password ([a66c7db](https://github.com/ThomasFourties/sc-planner/commit/a66c7dbc66677519d99889e35300d77929d68883))
* add forgot password ([0a9ce88](https://github.com/ThomasFourties/sc-planner/commit/0a9ce882b2cf5f3d09f15974243e40e7fec3763b))
* add health check module and endpoint, set global API prefix ([b905477](https://github.com/ThomasFourties/sc-planner/commit/b9054776ab28ee1bdc535c2b78118a258fc59499))
...
* add migration step to Dockerfile ([c5f5919](https://github.com/ThomasFourties/sc-planner/commit/c5f591914bdb253ca761b634388557b435837537))
...
* add reset password endpoint and client-side functionality ([a95eda0](https://github.com/ThomasFourties/sc-planner/commit/a95eda0cb206b4d41d132dad3ffd20b79e761a4f))
...
* **ci:** update deploy-staging workflow ([798172b](https://github.com/ThomasFourties/sc-planner/commit/798172b52bf5ae1a4f98890d7597e5b19ba3d20f))
...
* **release:** 0.0.2 ([d516890](https://github.com/ThomasFourties/sc-planner/commit/d51689048838e3f33defce18930a00ff28cc8575))
* **release:** 0.1.0 ([eb2d1dd](https://github.com/ThomasFourties/sc-planner/commit/eb2d1ddecc556288c272c45f2538a033a7c933c5))
* **release:** 0.1.0 ([0f96089](https://github.com/ThomasFourties/sc-planner/commit/0f96089301a9a5adc3c7a19590d68d178ffa42bd))
* **release:** 0.1.0 ([178e16a](https://github.com/ThomasFourties/sc-planner/commit/178e16a668380ca8fc0fc74fc584ae79ca607d6a))
...
* update deployment workflow names for clarity and improve staging image cleanup script ([628ad4a](https://github.com/ThomasFourties/sc-planner/commit/628ad4a646d1f5ba6a047a507c4be76aaa3a9dd1))
...
* update deployment workflows to improve tagging and add cleanup for staging images ([d7adb1c](https://github.com/ThomasFourties/sc-planner/commit/d7adb1cfe1d95c1b85f5ca7e54aba55d53c1244f))
...
* **ci:** update workflows ([7bc12c2](https://github.com/ThomasFourties/sc-planner/commit/7bc12c2a3cea71cb9f2917fc1a721971c7a18dea))
...
* optimize Dockerfile and deployment workflow ([aca5d8d](https://github.com/ThomasFourties/sc-planner/commit/aca5d8d6b96ad415507965ed5091c58e87992743))
...
* remove Nginx service from Docker Compose and update client Dockerfile to use new nginx.conf ([3249d64](https://github.com/ThomasFourties/sc-planner/commit/3249d6493f59e0378bd13d64dcb8159614aec06a))
...
* remove redundant API_URL environment variable ([9d8f3fd](https://github.com/ThomasFourties/sc-planner/commit/9d8f3fd6e1727c6216f3fcae7676d18963a043b5))
...
* update Docker Compose files for development and production environments ([bcef0ab](https://github.com/ThomasFourties/sc-planner/commit/bcef0ab80752888ab0606739f7c21e908c42992a))
...
* update Docker configuration ([6192c40](https://github.com/ThomasFourties/sc-planner/commit/6192c4088bd8ed40a63dd766a8473617d8402f6b))
...
* update Docker images to use dynamic tags ([0850fe6](https://github.com/ThomasFourties/sc-planner/commit/0850fe6de833f014dde6ac4ef6a51959b3ed9ce1))
...
* update Dockerfile ([3c90e8d](https://github.com/ThomasFourties/sc-planner/commit/3c90e8ddfbb483522a2eb0ac9d98db373c91729e))
* update Dockerfile ([ccc4e4e](https://github.com/ThomasFourties/sc-planner/commit/ccc4e4ee7ce05e2d8870ab8b41ea54b3485fbc59))
* update Dockerfile.dev ([27f9d45](https://github.com/ThomasFourties/sc-planner/commit/27f9d45f26dd7ea84d0a02f3a1765141fa3f0c7d))
* update Dockerfile.dev ([ff6549b](https://github.com/ThomasFourties/sc-planner/commit/ff6549bbde970d768f9243d1066556781b9e48f5))
* update Dockerfiles to use frozen lockfile for consistent dependency installation ([f1bd6d7](https://github.com/ThomasFourties/sc-planner/commit/f1bd6d7f3ce045d8d42a5217e7336c54c2694b49))
...
* update Nginx configuration in Docker setup to use default.conf and specify container name ([8f82a05](https://github.com/ThomasFourties/sc-planner/commit/8f82a0517e74e82e2d0ccd25956c7fc27adc0d84))
...
* update Nginx configuration to proxy API requests to server on port 3001 and disable redirects ([19f9d55](https://github.com/ThomasFourties/sc-planner/commit/19f9d5593a0a95e676c9d470e1636b9daf84dd9d))
...
* update Nginx configuration to use localhost for API proxy ([3c87102](https://github.com/ThomasFourties/sc-planner/commit/3c8710210d65022b6be8a3ad924b473670f5e42f))
